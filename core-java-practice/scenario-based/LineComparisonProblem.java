...
public class LineComparisonProblem {
	public static void main(String[] args) {
		...
		String isEqual = isBothLineEquals(lengthOfFirstLine, lengthOfSecondLine);
	...
	public static String isBothLineEquals(double lengthOfFirstLine, double lengthOfSecondLine) {
